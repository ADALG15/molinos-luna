<html lang="en">
    ...
    <body>
      ...
      <!---<a class="navbar-brand" href="#"><img src="#" width="60" height="60"></a>-->
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
        ...
        <br>
        <h1 class="display-6 text-center"><br>Formulario de Contacto</h1>
        <br>
        ...
        <form method="post" action="guardar.php">
            ...
            <div class="form-group">
                <label for="exampleInputEmail2">Apellido Paterno</label>
                <input type="text" name="apellidop" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail3">Apellido Materno</label>
                <input type="text" name="apellidom" class="form-control" id="exampleInputEmail3" aria-describedby="emailHelp">
            </div>
              <div class="form-group">
                <label for="exampleInputEmail4">Nombre de tu Empresa</label>
                <input type="text" name="empresa" class="form-control" id="exampleInputEmail4" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail5">Email</label>
                <input type="email" name="correo" class="form-control" id="exampleInputEmail5" aria-describedby="emailHelp">
            </div>
              <div class="form-group">
                <label for="exampleInputEmail6">Telefono</label>
                <input type="text" name="telefono" class="form-control" id="exampleInputEmail6" aria-describedby="emailHelp">
            </div>
            <button type="submit" name="guardar" class="btn btn-light">Enviar</button><br>
            <br>
        </form>
        </div>
        <br><br>
        <footer class="footer text-xs-center">
            <div class="container">
             <div class="row bg-white">
               <div class="col-8">
                  <small><b>Nuestro Producto</b><br>
                 •  Molino de Bolas.<br></small><br>
               </div>
               <div class="col-4">
                     <small><b>Contacto</b><br>
                       ...
                       </svg> <a href="formulario.php"> Formulario de Contacto</a> <br>
                     </small>
               </div>
             </div>
            
              <a><center><a href="principal.php">HOME</a><br>
                  LUNAS © 2020 | Anyeli Lizbeth Luna López (México, Michoacán)</center></a><br>
          </footer> 
    </body>
</html>
